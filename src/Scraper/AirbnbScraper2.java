...
//					System.out.println(startDate);
					if (!(startDate.plusDays(1)).isBefore(System.currentTimeMillis()))
						property.add_Airbnb_ihk_Availability(startDate.toString().split("T")[0]);
